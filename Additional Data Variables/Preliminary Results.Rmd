...
#### Internet and Vehicles per capita variables
...
columns_to_convert <- c("POP", "TotalNumVehicles", "TotalOwned", 
                        ...
                        "vehiclesavailable", "ThreeVehicleAvailable", 
...
model1<-lm(TelehealthVisits~EnrollmentStatus, TelehealthandPopulation_VehicleInternet) # without Income fixed effects
model2 <- lm(TelehealthVisits~EnrollmentStatus + State, TelehealthandPopulation_VehicleInternet) # with State fixed effects
model3<-lm(TelehealthVisits~EnrollmentStatus + State + Year, TelehealthandPopulation_VehicleInternet) # with State and Year fixed effects
