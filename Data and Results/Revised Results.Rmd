...
# Merge the reshaped Internet dataset with TelehealthandPopulation_Vehicle on State and Year
TelehealthandPopulation_VehicleInternetHospitalIncome_GDPUNRATE_Transit <- merge(TelehealthandPopulation_VehicleInternetHospital_GDPUNRATE_Transit, Income_long, by = c("State", "Year"), all = TRUE)
```
