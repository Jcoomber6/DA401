...
modelsummary(regz,
             title = "Figure 1: Effect of State and Year on the Number of Cars Owned (Per 100k people) impact on Number of Telehelath Visits",
...
modelsummary(regz,
             title = "Figure 2: Effect of State and Year on the Number of Cars Rented (Per 100k people) Impact on Number of Telehealth Visits",
             estimate = "{estimate}{stars}",
             gof_map = gofz,
             add_rows = rowz,
             coef_map = coefz) 
...
modelsummary(regz,
             title = "Figure 3: Effect of State and Year on the Number of People with Internet Access (Per 100k people) Impact on Number of Telehealth Visits",
             estimate = "{estimate}{stars}",
             gof_map = gofz,
             add_rows = rowz,
             coef_map = coefz) 
...
modelsummary(regz,
             title = "Figure 4: Effect of State and Year on The Number of Hospitals in each state (Per 100k people) Impact on Number of Telehealth Visits",
             estimate = "{estimate}{stars}",
             gof_map = gofz,
             add_rows = rowz,
             coef_map = coefz) 
