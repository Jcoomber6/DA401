...
modelsummary(regz,
             title = "Effect of State and Year on TotalOwned' (Per 100k people) impact on Number of Telehelath Visits",
...
modelsummary(regz,
             title = "Effect of State and Year on TotalRent's (Per 100k people) Impact on Number of Telehealth Visits",
             estimate = "{estimate}{stars}",
             gof_map = gofz,
             add_rows = rowz,
             coef_map = coefz) 
...
modelsummary(regz,
             title = "Effect of State and Year on WithInternet's (Per 100k people) Impact on Number of Telehealth Visits",
             estimate = "{estimate}{stars}",
             gof_map = gofz,
             add_rows = rowz,
             coef_map = coefz) 
...
modelsummary(regz,
             title = "Effect of State and Year on Hospital Count's (Per 100k people) Impact on Number of Telehealth Visits",
             estimate = "{estimate}{stars}",
             gof_map = gofz,
             add_rows = rowz,
             coef_map = coefz) 
